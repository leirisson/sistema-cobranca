...
describe("AsaasGateway", () => {
  ...
  it("reaproveita customer existente (buscado por cpfCnpj) e cria a cobrança (COB-03)", async () => {
    ...
    expect(resultado).toEqual({ gatewayChargeId: "pay_123", linkPagamento: "https://sandbox.asaas.com/i/pay_123" });
  });
